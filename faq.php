...
if (isset($_SESSION['login'])) {
    ...
    <body class="white">
        ...
        <main>
            ...
            <section id="faq">
                <div class="titulo">
                    <h1 class="fontbold">FAQ</h1>
                    <p class="font">Veja as principais dúvidas sobre o nosso serviço.</p>
                </div>
                <div class="container">
                    <div class="row nm">
                        <div class="col l8 offset-l2 m12 s12">
                            <ul class="collapsible z-depth-0 font">
                                <?php 
                                $rs = $con->query("select * from faqs;");
                                while($row = $rs->fetch(PDO::FETCH_OBJ)){
                                    ?>
                                    <li>
                                        <div class="collapsible-header fontbold active">
                                            <i class="mdi-action-help"></i> <?php echo $row->ds_pergunta; ?>
                                        </div>
                                        <div class="collapsible-body">
                                            <span><?php echo $row->ds_resposta; ?></span>
                                        </div>
                                    </li>
                                    <?php 
                                }
                                ?>
                           <!--  <li>
                                <div class="collapsible-header fontbold">
                                    <i class="mdi-action-help"></i> Minha empresa não possui nenhum sistema de controle de clientes/pagamentos. Qual solução da Wallet Family devo usar?
                                </div>
                                <div class="collapsible-body">
                                    <span>A Wallet Family é a solução ideal para o seu caso.</span>
                                </div>
                            </li>
                            <li>
                                <div class="collapsible-header fontbold">
                                    <i class="mdi-action-help"></i> Quais são os bancos compatíveis com as soluções?
                                </div>
                                <div class="collapsible-body">
                                    <span>Nossas soluções suportam 29 bancos, entre eles os mais utilizados no Brasil. Confira a lista completa aqui. Caso ainda não tenha suporte para o seu banco, adicionaremos este suporte sem custo adicional.</span>
                                </div>
                            </li>
                            <li>
                                <div class="collapsible-header fontbold">
                                    <i class="mdi-action-help"></i> O pagamento deve ser obrigatoriamente vinculado a uma conta bancária em nome da empresa?
                                </div>
                                <div class="collapsible-body">
                                    <span>Não. Para emitir boletos como pessoa física ou recebendo valores em conta bancária de pessoa física, você pode utilizar a Wallet Family.</span>
                                </div>
                            </li>
                            <li>
                                <div class="collapsible-header fontbold">
                                    <i class="mdi-action-help"></i> Os boletos gerados pelos seus sistemas podem ser protestados?
                                </div>
                                <div class="collapsible-body">
                                    <span>Sim, o protesto não depende do sistema e sim da carteira.</span>
                                </div>
                            </li> -->
                        </ul>
                    </div>
