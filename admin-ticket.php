...
if (isset($_SESSION['login'])) {
    ...
    <body>
        ...
        <div id="sidenav" class="active suave">
            ...
            <div class="perfil">
                <img class="u_foto" src=<?php echo $_SESSION['ds_caminho_img'];  ?>>
                <h6 class="font white-text"><div class="nome u_nome"><?php echo $_SESSION['ds_nome'];  ?></div><span class="cargo u_nivel"><?php if($_SESSION['tipo_usuario_idtipo_usuario'] == 1){echo "Administrador";}else{echo "Atendente";}  ?></span></h6>
                <input type="hidden" name="idusuario" id="idusuario" class="u_id" value=<?php echo $_SESSION['idusuario'];  ?>>
                <input type="hidden" id="destinatario" class="u_email">
