...
if (isset($_SESSION['login'])) {
    ...
    if (isset($_GET['idpost_blog'])) {
        if (!empty($_GET['idpost_blog'])) {
            $idpost_blog = $_GET['idpost_blog'];
            $rs = $con->query("select post_blog.* from post_blog where idpost_blog = '$idpost_blog';");
