...
if (isset($_SESSION['login'])) {
    ...
    <body>
        ...
        <div id="content" class="active suave">
            ...
            <h3 class="font suave"><span>FAQs</span></h3>
            <div class="lista-faqs">
                <ul>
                    <?php 
                    ...
                    while($row = $rs->fetch(PDO::FETCH_OBJ)){
                        ...
                        <li>
                            <h6 class="font truncate nome pergunta" >
                                <?php echo $row->ds_pergunta; ?>
                            </h6>
                            <h6 class="font resposta" >
                                <?php echo $row->ds_resposta; ?>
                            </h6>
                            <div class="controls suave">
                                <a class="font click suave editar-faq" data-pergunta='<?php echo $row->ds_pergunta; ?>' data-resposta='<?php echo $row->ds_resposta; ?>' data-idfaqs='<?php echo $row->idfaqs; ?>'>
                                    <i class="mdi-content-create"></i>Editar
                                </a>
                                <a class="font click suave deletar-faq" data-idfaqs='<?php echo $row->idfaqs; ?>'><i class="mdi-action-delete"></i>Deletar</a>
                            </div>
                        </li>
                        <?php 
                    }
                ...
                <div class="novoBanner suave">
                    ...
                    <form class="white suave" id="formulario" style="padding-top: 20px;">
                        <h6 class="fontbold">Cadastrar FAQ</h6>
                ...
                <button class="novoBannerBtn fontbold"><i class="mdi-content-add left"></i> add Faq</button>
            </div>
